...
|---|---|---|
| **`t24_env.py`** | local | manage the env store (`list`/`add`/`passwd`/`import-codittle`/`-tabby`/`-termius`) |
...
python t24_env.py import-tabby        # ...or from Tabby/Terminus  (import-termius too)
